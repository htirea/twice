...
case 0x40001A1:                                                               \
	return (cpuid_) == nds->nds_slot_cpu ? nds->auxspicnt >> 8 : 0;       \
case 0x40001A2:                                                               \
...
case 0x40001AF:                                                               \
	if ((cpuid_) == nds->nds_slot_cpu) {                                  \
		writearr<u8>(nds->cart_command_out, addr & 0x7, value);       \
	}                                                                     \
	return;                                                               \
case 0x4000208:                                                               \
...
case 0x40001AE:                                                               \
	if ((cpuid_) == nds->nds_slot_cpu) {                                  \
		writearr<u16>(nds->cart_command_out, addr & 0x7, value);      \
	}                                                                     \
	return;                                                               \
case 0x40001B8:                                                               \
	if ((cpuid_) == nds->nds_slot_cpu) {                                  \
...
case 0x40001AC:                                                               \
	if ((cpuid_) == nds->nds_slot_cpu) {                                  \
		writearr<u32>(nds->cart_command_out, addr & 0x7, value);      \
	}                                                                     \
	return;                                                               \
case 0x40001B0:                                                               \
	if ((cpuid_) == nds->nds_slot_cpu) {                                  \
